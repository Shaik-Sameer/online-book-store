...
<h2>Admin - ADD OLD BOOKS</h2>
	
</div>
	
	
<form method="POST" action="add_oldbook.php" enctype="multipart/form-data">
...
<button type="submit" class="btn" name="add_oldbook"> ADD BOOK</button>
