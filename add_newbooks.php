...
{
				$query = "INSERT INTO books(book_title,isbn, publisher,author,price,image_loc,description,index_img) VALUE('$booktitle','$isbn','$publisher','$author','$price','$name','$description','$contentimg_file')";
